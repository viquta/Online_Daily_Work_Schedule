--This file contains sample queries to test the database schema and functionality.
-- It includes queries for authentication, schedule viewing, and task management.
...
-- Add new task
-- NSERT INTO tasks (schedule_id, start_time, end_time, task_name, task_description)
-- ALUES (1, '19:00:00', '22:00:00', 'Client Call', 'Discuss project timeline');
